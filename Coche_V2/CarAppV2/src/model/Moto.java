...
public class Moto extends Vehiculo {
    ...
    public Moto(String marca, String modelo, int potencia,colorEnum color, motorEnum motor, LocalDate fechaFabricacion, String lugarFabricacion, Transmision transmission, double velocidad ,String matricula ,double peso , boolean sideCar , int cilindrada ){
