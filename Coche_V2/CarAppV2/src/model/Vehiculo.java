...
public abstract class Vehiculo {
    ...
    public Vehiculo(String marca, String modelo, int potencia, colorEnum color, motorEnum motor, LocalDate fechaFabricacion, String lugarCoche, Transmision transmission, double velocidad, String matriucla , double peso) {
        this.marca = marca;
        this.modelo = modelo;
