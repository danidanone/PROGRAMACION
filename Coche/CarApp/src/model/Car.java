...
public class Car extends Vehiculo {
    ...
    public Car(String marca, String modelo, int potencia, int numeroPuertas, colorEnum color, motorEnum motor, LocalDate fechaFabricacion, String lugarCoche, Transmision transmission, double velocidad , double peso) {
