...
public class Camion extends Vehiculo {
    ...
    public Camion(String marca, String modelo, int potencia,colorEnum color, motorEnum motor, LocalDate fechaFabricacion, String lugarCoche, Transmision transmission, double velocidad ,int numeroPuertas , double peso) {
