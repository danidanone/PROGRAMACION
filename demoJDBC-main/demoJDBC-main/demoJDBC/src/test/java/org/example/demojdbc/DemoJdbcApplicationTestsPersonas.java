...
@Transactional
@SpringBootTest
public class DemoJdbcApplicationTestsPersonas {
    ...
    void setUp() {
        ...
        repositorio.insertar(new Persona("javier", "sanchez", 30));
        repositorio.insertar(new Persona("maria", "sanchez", 25));
    }
    ...
    void insertarPersona() {
        ...
        repositorio.insertar(persona); // total: 3
        persona = new Persona("javier", "sanchez", 20);
        repositorio.insertar(persona); // total: 4
        List<Persona> lista = repositorio.buscarTodos();
